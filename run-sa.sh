...
#
# This one is meant to be used with the halo_optimizer application.
# the config file to run is passed in via the HALO_CONFIG_FILE
...
echo $HALO_CONFIG_FILE

# conda garbage:  -- shouldn't need this because it is done in the main script: run-sa-main.sh
